...
Nota: La aplicación ha sido probada con base de datos MYSQL, por lo que es posible que si lo corres con otro gestor, de algún error o no corra correctamente los seeders.
